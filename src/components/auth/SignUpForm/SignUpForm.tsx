    ...
    return (
        <div className="bg-white text-gray-500 max-w-96 mx-4 md:p-6 p-4 text-left text-sm rounded-xl shadow-[0px_0px_10px_0px] shadow-black/10">
            ...
            <form>
                ...
                <button type="submit" className="w-full mt-3 mb-3 bg-indigo-500 py-2.5 rounded-full text-white">Sign Up</button>
            </form>
            <p className="text-center mt-4">Already have an account? <Link href="/auth/sign-in" className="text-blue-500 underline">Sign In</Link></p>
