...
export const metadata: Metadata = {
    ...
    description: "The gender you are looking for does not exist or has been removed. Please check the URL or return to the homepage.",
};
    ...
    return (
        <section className="flex flex-col items-center justify-center text-sm max-md:px-4">
            ...
            <p className="text-sm md:text-base mt-4 text-gray-500 max-w-md text-center">
                The gender you are looking for does not exist or has been removed.
